...
class VersionAPI(BaseAPI):
    ...
    def list(self, file_id: int) -> List[DiskFileVersion]:
    ...
    def rollback(self, file_id: int, version: int) -> None:
        self._request(
            "POST", "/versions/rollback", json={"fileId": file_id, "version": version}
        )


class AsyncVersionAPI(AsyncBaseAPI):

    async def list(self, file_id: int) -> List[DiskFileVersion]:
